...
TEXT	start(SB), $-4
	...
	ADDU	$(MACHSIZE-BY2WD), R(MACH), R29	/* set up stack */
...
TEXT	utlbmiss(SB), $-4
	...
	MOVW	R23, M(LLADDR)		/* save R23, M(LLADDR) seems no meaning */
...
wasuser:
	...
	MOVW	8(R29), R29		/*  m->proc */
	MOVW	8(R29), R29		/*  m->proc->kstack */
	MOVW	M(STATUS), R26		/* redundant load */
	ADDU	$(KSTACK-UREGSIZE), R29
	MOVW	R31, Ureg_r31(R29)

	JAL		savereg1(SB)

	MOVW	R30, Ureg_r30(R29)
	MOVW	R(MACH), Ureg_r25(R29)
	MOVW	R(USER), Ureg_r24(R29)
	...
	MOVW	R29, R1				/* first arg for syscall */
	SUBU	$Notuoffset, R29
	JAL		syscall(SB)
...
sysrestore:
	...
	MOVW	Ureg_r31(R29), R31
	MOVW	Ureg_status(R29), R26
	MOVW	Ureg_r30(R29), R30
	MOVW	R26, M(STATUS)
	EHB
	MOVW	Ureg_pc(R29), R26		/* old pc */
	MOVW	Ureg_sp(R29), R29
	MOVW	R26, M(EPC)
	ERET
...
notsys:
	...
	MOVW	R29, R1				/* first arg for trap */
	SUBU	$Notuoffset, R29
	JAL		trap(SB)
...
restore:
	...
	MOVW	Ureg_r30(R29), R30
	MOVW	Ureg_r31(R29), R31
	MOVW	Ureg_r25(R29), R(MACH)
	MOVW	Ureg_r24(R29), R(USER)
	MOVW	Ureg_sp(R29), R29
	MOVW	R26, M(EPC)
	ERET
...
TEXT	savereg1(SB), $-4
	...
	MOVW	R27, Ureg_sp(R29)	/* user SP */

	MOVW	M(EPC), R1
	MOVW	M(CAUSE), R26

	MOVW	R23, Ureg_r23(R29)
	MOVW	R22, Ureg_r22(R29)
	MOVW	R21, Ureg_r21(R29)
	MOVW	R20, Ureg_r20(R29)
	MOVW	R19, Ureg_r19(R29)
	MOVW	R1, Ureg_pc(R29)
	RET
...
TEXT	savereg2(SB), $-4
	...
	MOVW	M(BADVADDR), R2
	MOVW	R26, Ureg_cause(R29)
	MOVW	M(TLBVIRT), R1
	MOVW	R2, Ureg_badvaddr(R29)
	MOVW	R1, Ureg_tlbvirt(R29)
	MOVW	HI, R1
	MOVW	LO, R2
	MOVW	R1, Ureg_hi(R29)
	MOVW	R2, Ureg_lo(R29)
					/* LINK,SB,SP missing */
	MOVW	R28, Ureg_r28(R29)
					/* R27, R26 not saved */
					/* R25, R24 missing */
					/* R23- R19 saved in save1 */
	MOVW	R18, Ureg_r18(R29)
	MOVW	R17, Ureg_r17(R29)
	MOVW	R16, Ureg_r16(R29)
	MOVW	R15, Ureg_r15(R29)
	MOVW	R14, Ureg_r14(R29)
	MOVW	R13, Ureg_r13(R29)
	MOVW	R12, Ureg_r12(R29)
	MOVW	R11, Ureg_r11(R29)
	MOVW	R10, Ureg_r10(R29)
	MOVW	R9, Ureg_r9(R29)
	MOVW	R8, Ureg_r8(R29)
	MOVW	R7, Ureg_r7(R29)
	MOVW	R6, Ureg_r6(R29)
...
/* restore R23-R19 */
TEXT	restreg1(SB), $-4
	MOVW	Ureg_r23(R29), R23
	MOVW	Ureg_r22(R29), R22
	MOVW	Ureg_r21(R29), R21
	MOVW	Ureg_r20(R29), R20
	MOVW	Ureg_r19(R29), R19
	RET
...
TEXT	restreg2(SB), $-4
					/* LINK,SB,SP missing */
	MOVW	Ureg_r28(R29), R28
					/* R27, R26 not saved */
					/* R25, R24 missing */
					/* R19- R23 restored in rest1 */
	MOVW	Ureg_r18(R29), R18
	MOVW	Ureg_r17(R29), R17
	MOVW	Ureg_r16(R29), R16
	MOVW	Ureg_r15(R29), R15
	MOVW	Ureg_r14(R29), R14
	MOVW	Ureg_r13(R29), R13
	MOVW	Ureg_r12(R29), R12
	MOVW	Ureg_r11(R29), R11
	MOVW	Ureg_r10(R29), R10
	MOVW	Ureg_r9(R29), R9
	MOVW	Ureg_r8(R29), R8
	MOVW	Ureg_r7(R29), R7
	MOVW	Ureg_r6(R29), R6
	...
	EHB
	MOVW	Ureg_r1(R29), R1	/* BOTCH */
	MOVW	Ureg_pc(R29), R26
	RET
...
TEXT	dcinvalid(SB), $-4			/* dcinvalid(virtaddr, count) */
	MOVW	M(STATUS), R10			/* old status -> R10 */
	MOVW	4(FP), R9
	MOVW	R0, M(STATUS)			/* intrs off */
	EHB
